...
import notify from '../assets/sound/messagepopup.mp3'
import { useSocketContext } from '../context/socketContext';

export const MessageContainer = ({ onBackUser,onlineUsers}) => {
      ...
      {!selectedConversation ? (
        ...
        <form onSubmit={handleSubmit} className='rounded-full text-black'>
          <div className='w-full rounded-full flex items-center bg-white'>
            <input value={sendData} onChange={handleMessage} required id='message' type='text'
